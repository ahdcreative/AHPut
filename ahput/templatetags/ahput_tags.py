...
@register.inclusion_tag('ahput/tags/entries_list.html', takes_context=True)
...
@register.inclusion_tag('ahput/tags/tags_list.html', takes_context=True)
...
@register.inclusion_tag('ahput/tags/categories_list.html', takes_context=True)
...
@register.inclusion_tag('ahput/tags/archives_list.html', takes_context=True)
    ...
    if blog_page.display_comments:
        try:
            ...
            raise Exception('To use comments you need to specify '
                            'AHPUT_COMMENTS_PROVIDER in settings.')
    return ""
...
@register.inclusion_tag('ahput/tags/post_to_linkedin.html', takes_context=True)
