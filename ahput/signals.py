...
def update_comment_count(sender, **kwargs):
    ...
    comment_class = import_model(settings.AHPUT_COMMENTS_PROVIDER)(entry_page.blog_page, entry_page)
    ...
    try:
        ...
        confirmation_received.connect(update_comment_count, dispatch_uid="ahput_comment_posted_id")
    except ImportError:
        pass
